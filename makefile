...
warehouse: main.o controller.o order-picker.o database-access.o state.o position.o
	g++ $(CFLAGS) -o warehouse.out main.o controller.o order-picker.o database-access.o state.o position.o `mysql_config --libs`
