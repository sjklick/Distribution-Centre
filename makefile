...
warehouse: main.o controller.o json-writer.o database-access.o order-picker.o state.o position.o
	g++ $(CFLAGS) -o warehouse.out main.o controller.o json-writer.o database-access.o order-picker.o state.o position.o `mysql_config --libs`
